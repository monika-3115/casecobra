...
const DesignConfigurator = ({
    ...
    function base64Toblob(base64: string, mimeType: string) {
        const byteCharecters = atob(base64)
            ...
            <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                                ...
                                <RadioGroup key={name} value={options[name]} onChange={(val) => {
                                    ...
                                    <div className="mt-3 space-y-4">
                                        {selectableOptions.map((option) => (
                                            <RadioGroup.Option key={option.value} value={option} className={({active, checked}) => cn("relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 boder-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
                                                {
                                                    "border-primary": active || checked,
                                                }
                                            )}>
                                                <span className="flex items-center">
                                                    <span className="felx flex-col text-sm">
                ...
                <div className="w-full px-8 h-16 bg-white">
                    ...
                    <div className="w-full h-full flex justify-end items-center">
                        ...
                        <Button onClick={() => saveConfiguration()} size="sm" className="w-full ml-20">
                            Continue
