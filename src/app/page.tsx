...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative max-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your image on a{' '} <span className="bg-green-600 text-white">Custom</span>
                {' '}
                Phone Case
              </h1>
      ...
      <section className="bg-slate-100 grainy-dark py-24">
        <MaxWidthrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in my handbag and that led to some pretty heavy scratchmarks on all of my last phone cases. This one, besides a barely noticeable scratch on the corner,{' '} 
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Beverly Cordon</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
      ...
      <section>
        <MaxWidthrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <div className="relative h-80 md:h-full md
              justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
